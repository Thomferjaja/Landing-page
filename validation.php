...
<html>
  ...
  <body>
    ...
    <div class="alert alert-secondary" role="alert">
      ...
      <br>
      Nous (re)verrons dans un cours ultérieur comment traiter un formulaire avec PHP et le valider.<br>
      Aujourd'hui, on s'intéresse qu'à la partie statique (HTML/CSS) du formulaire !
    </div>
